...
## What are Entitlements?<a name="what-are-entitlements"></a>
...
## Types of Entitlements<a name="types-of-entitlements"></a>

Entitlements are multifaceted, controlling various app capabilities including:

### <a name="app-sandbox">App Sandbox</a>
...
### <a name="hardware-access">Hardware Access</a>
...
### <a name="system-services">System Services</a>
...
### <a name="data-protection">Data Protection</a>
...
### <a name="network-access">Network Access</a>
...
## Specifying Entitlements<a name="specifying-entitlements"></a>
...
## Distribution and Approval<a name="distribution-and-approval"></a>
