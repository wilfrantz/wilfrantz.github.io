...
## <a name="shellcode-overview">Shellcode Overview</a>
...
## <a name="advantages-of-writing-custom-shellcode">Advantages of Writing Custom Shellcode</a>
...
## <a name="choosing-between-assembly-and-c">Choosing Between `Assembly` and `C`</a>
...
### <a name="writing-pure-assembly-shellcode">Writing Pure Assembly Shellcode</a>
...
#### <a name="working-with-bsd-type-system-calls">Working with BSD Type System Calls</a>
...
### <a name="executing-arbitrary-commands">Writing Shellcode in C</a>
...
## <a name="executing-arbitrary-commands">Executing Arbitrary Commands</a>
...
## <a name="creating-a-bind-shell">Creating a Bind Shell</a>
...
## <a name="using-c-code-to-call-arbitrary-functions">Using `C` Code to Call Arbitrary Functions</a>
...
## <a name="referencing-xnu-source-code">Referencing XNU Source Code</a>
